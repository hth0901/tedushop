...
namespace TeduShop.Service
{
    public interface IProductService
    {
        ...
        IEnumerable<Product> SearchByName(string keyword, int page, int pageSize, string sort, out int totalRow);
    ...
    public class ProductService : IProductService
    {
        ...
        {
            return this._productRepository.GetMulti(x => x.Status && x.Name.Contains(name)).Select(y => y.Name);
        }

        public IEnumerable<Product> SearchByName(string keyword, int page, int pageSize, string sort, out int totalRow)
        {
